...
export default function SidemenuAdmin() {
    ...
    return(
        <div className='h-98,5p w-pSidemenu bg-white fixed m-1 border-black rounded-xl solid border'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" 
                ...
                height="24" 
                viewBox="0 0 24 24"
                className='m-1 font-bold w-8 h-auto fill-black'>
                ...
                <span className='m-1 font-bold text-black'>Prestabanco</span>
            </div>
            <div className='m-1 h-87/100 text-black'>
                <ul className='w-full h-full flex flex-col space-y-2'>
                    <li className='m-1 p-2 w-full rounded-l-md font-bold hover:bg-black hover:text-white' onClick={()=>Navigate("/admin/home/clientsRegister")}>
